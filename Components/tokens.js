...
keywords.set("list", "LIST_KEYWORD");
keywords.set("dictionary", "DICTIONARY_KEYWORD");
keywords.set("dict", "DICTIONARY_KEYWORD");
keywords.set("is", "IS_KEYWORD");
keywords.set("in", "IN_KEYWORD");
keywords.set("to", "TO_KEYWORD");
keywords.set("if", "IF_KEYWORD");
keywords.set("else", "ELSE_KEYWORD");
keywords.set("match", "MATCH_KEYWORD");
keywords.set("default", "DEFAULT_KEYWORD");
keywords.set("for", "FOR_KEYWORD");
keywords.set("find", "FIND_KEYWORD");
keywords.set("job", "JOB_FUNCTION_KEYWORD");
keywords.set("not", "NOT_KEYWORD");
keywords.set("or", "OR_KEYWORD");
keywords.set("and", "AND_KEYWORD");
keywords.set("skip", "SKIP_KEYWORD");
keywords.set("stop", "STOP_KEYWORD");
keywords.set("continue", "CONTINUE_KEYWORD");
keywords.set("forward", "FORWARD_KEYWORD");
keywords.set("backward", "BACKWARD_KEYWORD");
...
brackets.set("(", "OPEN_PARENTHESIS");
brackets.set(")", "CLOSE_PARENTHESIS");
